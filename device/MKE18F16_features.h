...
#ifndef _MKE18F16_FEATURES_H_
#define _MKE18F16_FEATURES_H_
...
/* FLASH module features */
...
#if defined(CPU_MKE18F256VLH16) || defined(CPU_MKE18F256VLL16)
...
#elif defined(CPU_MKE18F512VLH16) || defined(CPU_MKE18F512VLL16)
    /* @brief Is of type FTFA. */
    #define FSL_FEATURE_FLASH_IS_FTFA (0)
    /* @brief Is of type FTFE. */
    #define FSL_FEATURE_FLASH_IS_FTFE (1)
    ...
    /* @brief Emulated eeprom size code 1111 mapping to emulated eeprom size in bytes (0xFFFF = reserved). */
    #define FSL_FEATURE_FLASH_FLEX_NVM_EEPROM_SIZE_FOR_EEESIZE_1111 (0x0000)
#endif /* defined(CPU_MKE18F256VLH16) || defined(CPU_MKE18F256VLL16) */
...
#define FSL_FEATURE_INTERRUPT_IRQ_MAX (91)
